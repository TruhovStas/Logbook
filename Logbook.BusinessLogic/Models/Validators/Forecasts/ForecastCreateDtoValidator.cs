...
{
    public class ForecastCreateDtoValidator : AbstractValidator<ForecastCreateDto>, IValidator
    {
        public ForecastCreateDtoValidator() 
        {
            ...
            RuleFor(x => x.Pressure1)
                ...
                .GreaterThan(0).WithMessage("Давление должен быть положительным.");
