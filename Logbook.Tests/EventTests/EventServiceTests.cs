...
//{
//    private EquipmentService _eventService;
...
//        var expectedEvents = new List<EquipmentResponseDto>
//            {
//                new EquipmentResponseDto { Id = 1, Title = "Event 1", Description = "Desc 1", DateTime = dateTime, Location = "Location 1", MaxParticipants = 20},
//                new EquipmentResponseDto { Id = 1, Title = "Event 2", Description = "Desc 2", DateTime = dateTime, Location = "Location 2", MaxParticipants = 30}
//            };
//        _mapperMock.Setup(m => m.Map<IEnumerable<EquipmentResponseDto>>(It.IsAny<IEnumerable<Event>>()))
...
//        var expectedEvent = new EquipmentResponseDto
//        { Id = 1, Title = "Event 1", Description = "Desc 1", DateTime = dateTime, Location = "Location 1", MaxParticipants = 20 };
//        _mapperMock.Setup(m => m.Map<EquipmentResponseDto>(ev)).Returns(expectedEvent);
...
//        // Arrange
//        var dateTime = DateTime.Now;
//        var eventCreateDto = new EquipmentCreateDto { Id = 1, Title = "Event 1", Description = "Desc 1", DateTime = dateTime, Location = "Location 1", MaxParticipants = 20 };
//        var ev = new Event { Title = "Event 1", Description = "Desc 1", DateTime = dateTime, Location = "Location 1", MaxParticipants = 20 };
//        var eventCreateResponseDto = new EquipmentCreateResponseDto { Id = 1 };

//        _mapperMock.Setup(m => m.Map<Event>(eventCreateDto)).Returns(ev);
//        _mapperMock.Setup(m => m.Map<EquipmentCreateResponseDto>(ev)).Returns(eventCreateResponseDto);
...
//        var eventUpdateDto = new ForecastUpdateDto { Id = 1, Title = "New Title", Description = "New Desc", DateTime = dateTime, Location = "New Location", MaxParticipants = 30 };
//        _mapperMock.Setup(m => m.Map(eventUpdateDto, existingEvent))
//                   .Callback<ForecastUpdateDto, Event>((src, dest) =>
//                   {
